        ...
        methods: {
            getCellCls (cell) {
                return [
                    `${prefixCls}-cell`,
                    {
                        [`${prefixCls}-cell-selected`]: !this.selectWeek && (cell.selected || cell.start || cell.end),
                        ...
                        [`${prefixCls}-cell-week-line`]: this.selectWeek && cell.week === this.selectedCell.week && cell.year === this.selectedCell.year
                    }
                ];
            },
